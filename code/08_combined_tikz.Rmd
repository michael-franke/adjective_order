...
levels(selection$sd_tall) <- c("$\\sigma_\\text{big} = 0.1$","$\\sigma_\\text{big}=0.2$")
...
tikz("../writing/2019 CogSci/plots/tikz.tex",standAlone=TRUE, width = 9 * scale_factor, height = 7 * scale_factor)
theme_set(theme_bw())
combined_plot
dev.off()
