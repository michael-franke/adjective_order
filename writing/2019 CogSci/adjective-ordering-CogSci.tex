...
$^3$ Humanoid and Cognitive Robotics Lab, Jo\v{z}ef Stefan Institute, Ljubljana (mihael.simonic@ijs.si)}
...
\citeA{simonic2018} systematically explored the idea that subjectivity-based ordering preferences arise under pressure from successful reference resolution. \gcs{@Mihael, could you take the first stab at a brief summary of your thesis?}
